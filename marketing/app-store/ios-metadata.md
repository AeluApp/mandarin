...
**Variant E (Calm tone):**
> Study Mandarin at your own pace. A warm, focused app with curated content, adaptive drills, and honest progress tracking. No gamification theatrics. Just the language.
...
- Adaptive scheduling that responds to your actual performance
- Dark mode with a warm, readable palette
...
- No leaderboards. Your study is not a competition.
- No AI-generated content. Every item was curated by a human learner.
- No notification manipulation. Study when you want to.

Progress tracking is honest. If you are not retaining something, the data will show it clearly. If you are improving, you will see exactly where and by how much. HSK-level projections are based on multiple criteria, not a single score.

WHO IT IS FOR

- Adults studying Mandarin seriously
- Heritage learners reconnecting with Chinese
- Professionals preparing for work in Chinese-speaking contexts
- Students preparing for HSK exams (levels 1-9)
- Self-study learners who want structure without condescension
- Anyone tired of being treated like a child by their language app
...
- Description word count: ~490 (well under 4000 char limit)
- Keywords avoid repeating words already in the app name or subtitle
- Promotional text rotates; test each variant for at least 7 days before evaluating
- "What's New" should be updated with every release; keep the tone calm and direct
