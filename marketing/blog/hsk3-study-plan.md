...
I built [Aelu](https://aelu.app) because I wanted a tool that tracks HSK readiness across all of these dimensions — vocabulary, listening, reading, tones, grammar — and tells you exactly where to spend your study time. It runs 27 drill types, adjusts to your weak spots automatically, and gives you a real forecast of when you'll be ready to test. HSK 1-2 content is free. If you're starting your HSK 3 prep and want a system that does the tracking for you, it might be worth a look.
