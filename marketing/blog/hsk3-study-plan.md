...
Most HSK 3 advice boils down to "learn the 600 words and you'll be fine." That advice fails people constantly. I know because I followed it, and it nearly failed me.

HSK 3 is the level where Mandarin stops being a party trick and starts being a usable language. It's also where a lot of learners stall out, not because the material is impossibly hard, but because their study approach doesn't match what the test actually demands. Here's what I wish someone had told me before I started preparing.

## What HSK 3 Actually Tests

Let's get specific. HSK 3 has three sections:

- **Listening** (~35 minutes): 40 items. You hear short dialogues and answer multiple-choice questions. The audio plays twice.
- **Reading** (~30 minutes): 30 items. Short passages, sentence ordering, fill-in-the-blank with context clues.
- **Writing** (~15 minutes): 10 items. Rearranging words into sentences and writing short responses from prompts.
...
I've watched a lot of learners prepare for HSK 3. The failure modes are predictable:
...
**Mistake 3: Skipping grammar patterns.** HSK 3 introduces structures like comparative sentences (比), resultative complements (到, 完, 好), directional complements, and 把 sentences. These show up everywhere in reading and writing. You can't guess your way through them.
...
**Grammar (10 min/day):** Introduce 2-3 grammar patterns per week. Don't just read the explanation — write 3-5 example sentences for each pattern. Focus on high-frequency structures first: 比 comparisons, 已经...了, 一边...一边, 虽然...但是.
...
**Grammar (10 min/day):** Cover the remaining HSK 3 grammar patterns. Pay special attention to: 把 sentences (these are notoriously confusing), resultative complements, potential complements (得/不 + complement), and the various uses of 了.
...
- **Vocabulary coverage:** What percentage of HSK 3 words can you produce correctly (not just recognize) within a few seconds?
- **Listening accuracy by speed:** Can you comprehend at 0.8x? 1.0x? 1.2x? If you can handle 1.2x, the test will feel slow.
- **Grammar pattern accuracy:** When you see a 把 sentence, can you parse it correctly more than 80% of the time?
- **Tone accuracy:** Can you distinguish second tone from third tone in running speech? This is the most commonly confused tone pair, and it matters for listening comprehension.
- **Section balance:** Are your listening, reading, and writing scores roughly even, or is one section dragging you down?
...
I want to emphasize this because it's almost never discussed in HSK prep guides.
...
This isn't a speaking problem (though it's that too). It's a *listening* problem. Your brain needs to have accurate tone templates for every word so it can match incoming sounds correctly. If your mental model of 买 (mǎi, "to buy," third tone) is fuzzy, you might confuse it with 卖 (mài, "to sell," fourth tone) in fast speech. That's not a vocabulary gap — you know both words. It's a tone discrimination gap.

The fix: practice listening to minimal tone pairs. Drill the difference between 是 (shì) and 十 (shí). Between 买 and 卖. Between 睡 (shuì) and 水 (shuǐ). Do this with real audio, not just in your head.
...
I built [Mandarin](https://mandarin.app) because I wanted a tool that tracks HSK readiness across all of these dimensions — vocabulary, listening, reading, tones, grammar — and tells you exactly where to spend your study time. It runs 27 drill types, adjusts to your weak spots automatically, and gives you a real forecast of when you'll be ready to test. HSK 1-2 content is free. If you're starting your HSK 3 prep and want a system that does the tracking for you, it might be worth a look.
